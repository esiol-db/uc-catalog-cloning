...
def securable_transfer_decorator(func):
    def wrapper(self, securable_type, old_securable_full_name, new_securable_full_name, **kwargs):
        securable = None
        analysis_exception_hit = 0
        try:
            securable = self.securable_dict[securable_type][0].get(new_securable_full_name)
            ...
            securable, analysis_exception_hit = func(self, securable_type, old_securable_full_name, new_securable_full_name, **kwargs)
        finally:
        ...
        return securable
    return wrapper
@securable_transfer_decorator
def _get_or_create_transfer(self, securable_type, old_securable_full_name, new_securable_full_name, **kwargs):
    analysis_exception_hit = 0
    securable = None
    try:
        securable = self.securable_dict[securable_type][0].create(
        ...
        print(f'\n\t\t{str(ae)}')
    return securable, analysis_exception_hit
@securable_transfer_decorator
def _get_or_create_managed_table_transfer(self, securable_type, old_securable_full_name, new_securable_full_name, **kwargs):
    tbl = kwargs['tbl']
    analysis_exception_hit = 0
    new_table = None
    try:
        ...
        analysis_exception_hit = 1
        print(f'\n\t\t{str(ae)}')
    return new_table, analysis_exception_hit
...
class MigrateCatalog():
  ...
  def _securable_transfer_decorator(func):
    def wrapper(self,
                securable_type: catalog.SecurableType, 
                old_securable_full_name: str, 
      ...
      try:
        ...
        print(f'\tCloning {self.securable_dict[securable_type][1]} {new_securable_full_name} and transferring permissions ... ', end=' ')  
        securable, analysis_exception_hit = func(self, 
                                                    securable_type, 
  ...
  def _get_or_create_transfer(self, 
    ...
    try:
        ...
        analysis_exception_hit = 1
        print(f'\n\t\t{str(ae)}')
    return new_securable, analysis_exception_hit
